classdef InertiaBead < Bead
    methods
        function obj = InertiaBead(varargin)
        ...
        function new_velocity = updateVelocityImpl(obj,varargin)
            ...
            new_velocity = dt*(concentration.*obj.orientation/obj.mass...
                + obj.acceleration);
        ...
        function new_angular_velocity = updateAngularVelocityImpl(obj, concentration_gradient,dt)
            ...
            new_angular_velocity = obj.angular_velocity +...
                (dt)*(obj.bead_size/obj.inertia)*cross_product;
